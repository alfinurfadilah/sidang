                ...
                <i class="" aria-hidden="true"></i></a>
                    ...
                    @foreach ($jadwalpemasangan as $sk => $item)
                        <tr>
                            ...
                            <td>
                            <button class="btn btn-danger mb-2" aria-hidden="true" data-bs-toggle="modal"
                    ...
                    <label for="nomor_handphone">Nomor_Handphone</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('Alamat_Pemasangan') is-invalid @enderror" name="alamat_pemasangan"
                                value="{{ $item->alamat_pemasangan ?? old('alamat_pemasangan') }}" id="Alamat_Pemasangan">
                        ...
                        <button type="submit" class="btn btn-danger"><i class="fas fa-save"> Simpan </i></button> 
                                <a href="{{ route('jadwalpemasangan.index') }}"  class="btn btn-warning"><i class="fa fa-times-circle"> Batal </i></button></a>
                    </form>
                </table>
            </div>
        </div>
